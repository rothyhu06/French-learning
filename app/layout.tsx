...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="zh-CN"><body><LearningProvider>{children}</LearningProvider></body></html>; }
